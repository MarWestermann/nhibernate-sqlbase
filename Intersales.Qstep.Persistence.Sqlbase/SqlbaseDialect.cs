...
{
    /// <summary>
    /// A dialect for Sqlbase. 
    /// </summary>
    public class SqlbaseDialect : Dialect
    {
        public override string CurrentTimestampSelectString
        {
            get { return "select sysdatetime from firma"; }
        }
        ...
        protected virtual void RegisterCharacterTypeMappings()
        {
            ...
            RegisterColumnType(DbType.StringFixedLength, "NCHAR(254)");
            RegisterColumnType(DbType.StringFixedLength, 2000, "NCHAR($l)");
            RegisterColumnType(DbType.String, "NVARCHAR(254)");
        ...
        protected virtual void RegisterNumericTypeMappings()
        {
            ...
            RegisterColumnType(DbType.Currency, "FLOAT");
            RegisterColumnType(DbType.Single, "FLOAT");
            RegisterColumnType(DbType.Double, "DOUBLE PRECISION");
            RegisterColumnType(DbType.Double, 19, "DOUBLE PRECISION");
            RegisterColumnType(DbType.Decimal, "DECIMAL");
            RegisterColumnType(DbType.Decimal, 19, "DECIMAL");
        }
        ...
        {
            throw new NotImplementedException(sequenceName);
